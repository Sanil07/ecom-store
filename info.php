...
pre
{
  ...
  white-space: pre;
	...
	<div class="info" style="display:none">
		<a href="welcome.php" style="color:#edf40c;text-decoration: none;">Estore</a>
	</div>
	<body>
		...
		<div class= "container" style="overflow: hidden; display: flex; justify-content:space-around;">
			<center>
				<figure>
					<img src="https://cdn3.iconfinder.com/data/icons/user-group-black/100/user-process-512.png" class="image" alt="sumanth and sanil" width="200px" height="200px" border="3">
				<pre><bold>sumanth and sanil</bold>  
 <italic>Backend Developer :-php        Front End Designer:-html,css        data base:-mysql  </italic></pre></figcaption>
				</figure>
		...
		<footer class="ct-footer">
			<div class="container">
				<ul class="ct-footer-list text-center-sm">
				    ...
				    <li>
				        <h2 class="ct-footer-list-header"> <a href="login.php" >Estore</h2>
				        <ul>
					        <li>
					            <a href="info.php">About Us</a>
					        </li>
				    ...
				    <div class="row">
				        ...
				        <div class="col-sm-6 col-md-3">
				          	<address>
				            	...
				            	pace campus<br>pace ullal 671123<br>
		  	...
		  	<div class="ct-footer-post">
		    	<div class="container">
		      		...
		      		<div class="inner-right">
		        		<p>Copyright © EstoreCo.&nbsp;<a href="">Privacy Policy</a></p>
		        		<p><a class="ct-u-motive-color" href="" target="_blank">Web Design</a> by sumanth and sanil on <a href="" target="_blank">pace</a></p>
		      		</div>
		    	</div>
		  	</div>
		</footer>
